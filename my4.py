        ...
        if location in LOCATIONS:
            match location:
                ...
                case 'Логово Огров':
                    ...
                    Yrgash = Ogr("Ургаш", 300, 65, 'mace', 'leather_jacket')
                    Varhcha = Ogr("Варча", 300, 65, 'mace', 'chainmail')
...
while obychenie:
    ...
    if a == 'A':
        print('Здраствуй игрок , сейчас ты играешь в Алеша_Попович_Текстовая_игруха\n'
              'Это типо а ля открытый мир скайрима, сейчас тебя быренько всему обучим, для продолжения нажми клавишу "B"')
        b = input()
        if b == "B":
            print('')
            print("Обучение:")
            ...
            print('')
            print('Кстати о инвентаре, нажав клавишу "E" будет выведен ваш инвентарь, и ваши характеристики\n'
...
Game = True
print('Ну все начинай , вводи команду')

while True:
    d = input()
    if d in spisok_funksi:
